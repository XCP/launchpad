...
Before release: publish/review the SDK dependency, review transaction-critical translations with regional speakers, and validate supported wallet adapters against the node versions being deployed. Merging, SDK release, website deployment, and extension store publication are separate actions.
