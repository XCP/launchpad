  ...
  return (
    <D.Root open={open} onOpenChange={onOpenChange}>
      <D.Portal>
        ...
        <D.Content className="modal-pop fixed left-1/2 top-[15vh] z-50 w-[calc(100vw-2rem)] max-w-sm -translate-x-1/2 rounded-3xl bg-white dark:bg-gray-900 p-3 shadow-xl focus:outline-none">
          <div className="flex items-center justify-between px-2 pb-2 pt-1">
            <D.Title className="text-sm font-semibold text-gray-900 dark:text-gray-100">
              {title}
            </D.Title>
            <D.Close
              aria-label="Close"
