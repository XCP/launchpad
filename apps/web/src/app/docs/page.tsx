  ...
  return (
    <article className="mx-auto max-w-2xl space-y-10">
      ...
      <section id="launch-mechanism" className="space-y-3">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">A launch moves through four phases:</p>
        <ol className="list-decimal space-y-2 pl-5 text-sm text-gray-700 dark:text-gray-300">
          <li>
            ...
            <em>before</em> its <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">start_block</code>.
            Until that block arrives the fairminter is{" "}
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">pending</code> and
          ...
          <li>
            ...
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">start_block</code>.
        ...
        <dl className="divide-y divide-gray-100 dark:divide-gray-800 overflow-hidden rounded-lg border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 text-sm">
          {(
            ...
            <div key={term} className="px-4 py-3">
              ...
              <dd className="mt-0.5 text-gray-600 dark:text-gray-400">{def}</dd>
            </div>
          ))}
        </dl>
      </section>
      ...
      <section id="risk-disclosures" className="space-y-3">
        ...
        <ul className="list-disc space-y-2 pl-5 text-sm text-gray-700 dark:text-gray-300">
          ...
          <li>
            ...
            JSON (via{" "}
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">lock_description</code>)
      ...
      <section id="network" className="space-y-3">
        ...
        <ul className="list-disc space-y-1 pl-5 text-sm text-gray-700 dark:text-gray-300">
          ...
          <li>
            ...
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">fairmint_pool</code>,
      ...
      <section id="message-format" className="space-y-3">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          ...
          the pool fields <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">pool_quantity</code>{" "}
          and <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">lp_asset</code> set.
          Mints are ordinary fairmint messages in whole-lot multiples of{" "}
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">quantity_by_price</code>.
        </p>
        <p className="text-sm text-gray-700 dark:text-gray-300">
          One integration trap worth knowing:{" "}
          Counterparty Core 11.3+ returns{" "}
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">pool_quantity_normalized</code> and{" "}
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">max_mint_per_address_normalized</code>{" "}
          under <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">verbose=true</code>. Use them for
      ...
      <section id="composing" className="space-y-3">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          ...
          broadcast, done. Add{" "}
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">verbose=true</code> for a
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          ...
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">soft_cap</code> must equal{" "}
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">
            hard_cap − premint − pool_quantity
          </code>{" "}
          whenever <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">pool_quantity</code>{" "}
          ...
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">lp_asset</code> with real
      ...
      <section id="conformance" className="space-y-3">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          ...
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">start_block</code> must
          ...
          relaxes to <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">≤</code> once
          ...
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">NEW_FAIRMINTER</code>{" "}
      ...
      <section id="reading-state" className="space-y-3">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">Pools, prices, and quotes:</p>
        <CodeBlock>{CURL_POOL}</CodeBlock>
        <p className="text-sm text-gray-700 dark:text-gray-300">Holders:</p>
        <CodeBlock>{CURL_HOLDERS}</CodeBlock>
        <p className="text-sm text-gray-700 dark:text-gray-300">
          <strong>Lifecycle detection recipe.</strong> Success and failure
          both end at fairminter status <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">closed</code>,
          so the pool row is the disambiguator:
        </p>
        <ul className="list-disc space-y-1 pl-5 text-sm text-gray-700 dark:text-gray-300">
          <li>
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">pending</code> →
            scheduled
          </li>
          <li>
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">open</code> → minting
          </li>
          <li>
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">closed</code> +{" "}
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">/v2/pools/&lt;ASSET&gt;/XCP</code>{" "}
            returns a pool → graduated
          </li>
          <li>
            <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">closed</code> with no
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          ...
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">soft_cap_deadline_block</code>{" "}
          ...
          while status is <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">open</code>.
          ...
          <code className="rounded bg-gray-100 dark:bg-gray-800 px-1">FAIRMINTER_UPDATE</code>{" "}
      ...
      <section id="support-and-terms" className="space-y-3">
        ...
        <p className="text-sm text-gray-700 dark:text-gray-300">
          ...
          value. Read the{" "}
          <a href="#risk-disclosures" className="text-purple-600 dark:text-purple-400 underline">
            risk disclosures
          </a>{" "}
          before minting.
        </p>
