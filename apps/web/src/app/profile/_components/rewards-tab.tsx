...
export function RewardsTab({ account }: { account: RewardAccount }) {
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap items-baseline justify-between gap-2 rounded-xl bg-gray-50 p-4">
        <span className={LABEL}>Lifetime earned</span>
        <p className="text-xl font-bold tabular-nums text-gray-900">
          {commasRaw(account.lifetimeEarnedQuantity)}{" "}
          <span className="text-xs font-medium text-gray-500">MINTS</span>
        </p>
      </div>
      ...
      <div className="overflow-x-auto">
        <div className="min-w-[34rem]">
          <div className="grid grid-cols-[minmax(0,1fr)_7rem_5rem_7rem] gap-x-4 pb-1 text-[10px] font-medium uppercase tracking-wider text-gray-500">
            ...
            {account.payouts.map((payout) => (
              ...
              >
                <div className="min-w-0">
                  ...
                  <p className="truncate text-xs text-gray-400">{payout.batchId}</p>
                </div>
