  ...
  const buttonLabel = busy
    ...
    : limitAmountRaw === 0
      ...
      : !spendBalanceSettled
        ? t("Checking balance…")
      : insufficient
          ? t("Insufficient {asset} balance", { asset: side === "buy" ? "XCP" : asset })
          : side === "buy"
            ? t("Place limit buy")
            : t("Place limit sell");
  ...
  return (
    <div className="rounded-3xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900 p-2">
      ...
      <div>
        <Well
          focusable
          label={t("Price · XCP per {asset}", { asset })}
          topRight={
            spot !== null ? (
            ...
            <div className="mt-1">
              ...
              >
                <AmountInput
                  ...
                  ariaLabel={t("Amount of {asset}", { asset })}
          ...
          <div className="mt-2 rounded-2xl border border-green-200 dark:border-green-800 bg-green-50 dark:bg-green-950/40 p-4 text-sm">
            <div className="flex items-center justify-between">
              <span className="font-semibold text-green-800 dark:text-green-300">
                {t("Order broadcast")} — <TxLink txid={compose.txid} />
              </span>
              <button
                type="button"
