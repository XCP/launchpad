...
import type { fetchPool } from "@/lib/api/counterparty";
import type {
  fetchLaunchPage,
  fetchLaunchStats,
  fetchMinterEarnings,
...
import type { fetchBtcUsd, fetchXcpUsd } from "@/lib/api/price";
...
export function RewardsContent({ stats, earners, graduates, mintsPool, xcpUsd, btcUsd, rewardBatches }: {
  stats: Awaited<ReturnType<typeof fetchLaunchStats>>;
  earners: Awaited<ReturnType<typeof fetchMinterEarnings>>;
  graduates: Awaited<ReturnType<typeof fetchLaunchPage>>;
  mintsPool: Awaited<ReturnType<typeof fetchPool>>;
  xcpUsd: Awaited<ReturnType<typeof fetchXcpUsd>>;
  btcUsd: Awaited<ReturnType<typeof fetchBtcUsd>>;
  rewardBatches: Awaited<ReturnType<typeof fetchRewardBatches>>;
}) {
  const num = useNumbers();
  const t = useT();  // The chain keeps minting after this programme ends; the progress meter is
